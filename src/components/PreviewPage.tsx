...
const ActionButton: FC<ActionButtonProps> = ({ onClick, loading, icon, title, desc, color, disabled }) => {
  ...
  return (
    <button 
      ...
      // Di HP: flex-1 (mengisi space row seimbang), w-12 h-12 rounded-full biar jadi bulatan icon minimalis.
      // Di Desktop (lg): dikembalikan ke w-full h-20 rounded-3xl memanjang kesamping.
    ...
    >
      ...
      {/* Teks Deskripsi: Tersembunyi total di mobile, otomatis tampil normal di desktop (lg) */}
